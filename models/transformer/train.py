...
def get_ds(config):
    ...
    ds_raw = label(load_json('/home/alex/ml_prefetching/dataset_gathering/correct_out_3.txt'), 10, 10) #load_dataset(f"{config['datasource']}", f"{config['lang_src']}-{config['lang_tgt']}", split='train')
